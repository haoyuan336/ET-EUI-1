...
namespace ET
{
    public class CodeLoader : Singleton<CodeLoader>, ISingletonAwake
    {
        ...
        {
            // if (!Define.IsEditor && this.enableDll)
            // {
        ...
        {
            // Debug.Log($"code loader star {Define.IsEditor} {this.enableDll}");
            ...
            //
            // Type[] modelTypes = this.modelAssembly.GetTypes();
            //
            // Debug.Log($"model typs {modelTypes.Length}");
            ...
            //         //
            //         // Debug.Log($"assemelies count {assemblies.Length}");
            //         //
            ...
            //
            // Type[] types = typeof(World).Assembly.GetTypes();
            // Debug.Log($"types {types.Length}");
            //
            // Type[] initAm = typeof(Init).Assembly.GetTypes();
            //
            // Debug.Log($"init am {initAm.Length}");
            //
            // this.modelAssembly = Assembly.Load("Unity.Model");
            //
            // Type[] modelTypes = this.modelAssembly.GetTypes();
            //
            // Debug.Log($"model type {modelTypes.Length}");
            //
            // Type[] hotfix = hotfixAssembly.GetTypes();
            //
            // Debug.Log($"hot fix {hotfix.Length}");
            //
            // Type[] hotfixview = hotfixAssembly.GetTypes();
            //
            // Debug.Log($"hot fix view {hotfixview.Length}");
            ...
            // World.Instance.AddSingleton<CodeTypes, Assembly[]>(new[] { typeof(World).Assembly });
        ...
        //             Assembly[] assemblies = AppDomain.CurrentDomain.GetAssemblies();
        //
        //             Debug.Log($"load assembiles count {assemblies.Length}");
        //             foreach (Assembly ass in assemblies)
        //             {
        //                 string name = ass.GetName().Name;
