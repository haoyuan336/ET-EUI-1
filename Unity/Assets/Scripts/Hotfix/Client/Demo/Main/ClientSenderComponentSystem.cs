...
namespace ET.Client
{
    ...
    public static partial class ClientSenderComponentSystem
    {
        ...
        public static async ETTask<NetClient2Main_Login> LoginAsync(this ClientSenderComponent self, string account,
        string password)
        {
        ...
        public static async ETTask<long> LoginGateAsync(this ClientSenderComponent self, PlayerComponent playerComponent, int zoneConfigId)
        {
            Main2NetClient_LoginGate main2NetClientLoginGate = Main2NetClient_LoginGate.Create();

            main2NetClientLoginGate.Address = playerComponent.Address;

            main2NetClientLoginGate.GateId = playerComponent.GateId;

            main2NetClientLoginGate.Account = playerComponent.Account;

            main2NetClientLoginGate.Password = playerComponent.Password;

            main2NetClientLoginGate.Key = playerComponent.LoginGateKey;

            main2NetClientLoginGate.ZoneConfigId = zoneConfigId;

            NetClient2Main_LoginGate loginGate =
                    await self.Root().GetComponent<ProcessInnerSender>().Call(self.netClientActorId, main2NetClientLoginGate) as
                            NetClient2Main_LoginGate;

            return loginGate.PlayerId;
        }
